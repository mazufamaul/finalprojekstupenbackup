      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3">
              <div class="site-logo">
                <a href="{{url('/interface')}}"><strong>CarRental</strong></a>
              </div>
            </div>
          ...
          <div class="row align-items-end ">
            <div class="col-lg-5">
              ...
              <div class="intro">
                ...
                <div class="custom-breadcrumbs"><a href="{{url('/interface')}}">Home</a> <span class="mx-2">/</span> <strong>About</strong></div>
              </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0 order-lg-2">
            <img src="admin/images/hero_2.jpg" alt="Image" class="img-fluid rounded">
          </div>
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="admin/images/person_1.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="admin/images/person_2.jpg" alt="Image"
                 class="img-fluid">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="post-entry-1 h-100 person-1">
                ...
                <img src="admin/images/person_3.jpg" alt="Image"
                 class="img-fluid">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <img src="admin/images/hero_1.jpg" alt="Image" class="img-fluid rounded">
          </div>
